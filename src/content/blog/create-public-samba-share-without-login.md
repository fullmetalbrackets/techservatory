...
description: "Normally a Samba share requires login with a username and password, but sometimes you just want an open network share with no login required. Here's a quick and easy way of making an open Samba share on your local network."
pubDate: "July 4, 2023"
tags:
  - Samba
  - Linux
...
> **ⓘ Note**<br><br> The parameters before <code>[public]</code> is optional, I found <a href="https://eggplant.pro/blog/faster-samba-smb-cifs-share-performance" target="_blank" rel="noopener noreferrer">this blog post</a> about it and I have definitely noticed it makes transfer speeds a little faster.
